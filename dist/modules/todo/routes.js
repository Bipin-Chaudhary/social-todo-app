...
router.post('/', authCheck_1.default, [
    (0, express_validator_1.body)('sDesc').not().isEmpty(),
    (0, express_validator_1.body)('dDate').not().isEmpty()
], controllers_1.default.add);
router.put('/:id', authCheck_1.default, [
    (0, express_validator_1.body)('sDesc').not().isEmpty(),
    (0, express_validator_1.body)('dDate').not().isEmpty()
], controllers_1.default.edit);
router.put('/mark-complete/:id', authCheck_1.default, [
    (0, express_validator_1.body)('bCompleted').not().isEmpty()
], controllers_1.default.markComplete);
...
// public apis
router.get('/user/list/public/:id', controllers_1.default.listPublicTodos);
